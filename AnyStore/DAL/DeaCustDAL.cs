...
namespace AnyStore.DAL
{
    class DeaCustDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                //SQL Connection for Database Connection using connection manager
        ...
        public bool Insert(DeaCustBLL dc)
        {
            ...
            try
            {
                //Creting SQL Connection First using connection manager
                using (SqlConnection conn = DatabaseConnectionManager.CreateConnection())
                {
        ...
        public bool Delete(DeaCustBLL dc)
        {
            ...
            try
            {
                //SQlConnection for Database Connection using connection manager
                using (SqlConnection conn = DatabaseConnectionManager.CreateConnection())
                {
        ...
        public DataTable Search(string keyword)
        {
            ...
            try
            {
                //Create a Sql Connection using connection manager
                using (SqlConnection conn = DatabaseConnectionManager.CreateConnection())
                {
        ...
        public DeaCustBLL SearchDealerCustomerForTransaction(string keyword)
        {
            ...
            try
            {
                //Create a DAtabase Connection using connection manager
                using (SqlConnection conn = DatabaseConnectionManager.CreateConnection())
                {
        ...
        public DeaCustBLL GetDeaCustIDFromName(string Name)
        {
            ...
            try
            {
                //SQL Conection here using connection manager
                using (SqlConnection conn = DatabaseConnectionManager.CreateConnection())
                {
